...
return [
    ...
    'referentDocumentNumber'   => $_SESSION['promet–prodaja-sa-identifikacijom']['refDocumentNumber'],
    'referentDocumentDateTime' => unserialize($_SESSION['promet–prodaja-sa-identifikacijom']['refDocumentDateTime']),
    'items'                    => [
        [
            'gtin'      => '9002490100070',
